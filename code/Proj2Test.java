...
//  TODO: Your dataset filename. Expected format is CSV
  private static final String FILENAME = "src/opt/test/car_quality.csv";
  ...
  private static int numberHiddenLayerNodes = 35;
...
//  TODO: Set this to false if you retained the best SA params from a previous run
  ...
  public static void main(String[] args) {
    if (args.length == 0) {
      System.out.println("Please include algorithm type as argument: ga, sa, or rhc");
      System.exit(0);
    }
    initializeInstances();
...
//    Now determine the NN performance. Results are simply printed out.
    ...
    /* RHC */
    if (args[0].equals("rhc")) {
        for(trainIterations = 0; trainIterations < 2001; trainIterations += 100) {
...
//      TODO: Keep this very small
    ...
    if (args[0].equals("ga")) {
        for(trainIterations = 0; trainIterations < 51; trainIterations += 10) {
...
//    Convert nanoseconds to seconds
  ...
  public static void runRHC(int trainIterations) {
    ...
    System.out.printf("===========Randomized Hill Climbing %d =========\n", trainIterations);
...
//      Find the average error for this network configuration
  ...
  public static void runSA(int trainIterations, double temp, double cooling) {
    ...
    System.out.printf("===========Simulated Annealing %d =========\n", trainIterations);
...
//      Find the average error for this configuration
  ...
  public static void runGA(int trainIterations) {
    ...
    System.out.printf("===========Genetic Algorithms %d =========\n", trainIterations);
