...
public class MaxKColoringTest {
    /** The n value */
    private static final int N = 150; // number of vertices
    ...
    public static void main(String[] args) {
        ...
        FixedIterationTrainer fit = new FixedIterationTrainer(rhc, w*3333);
        fit.train();
        System.out.printf("%d,%f,",K,ef.value(rhc.getOptimal()));
        ...
        fit = new FixedIterationTrainer(sa, w*3333);
        fit.train();
        ...
        fit = new FixedIterationTrainer(ga, w*8);
        fit.train();
